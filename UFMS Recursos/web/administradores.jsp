<%-- 
    ...
    Created on : 21/02/2013, 18:09:43
    Author     : Kleber
--%>

<%@page import="br.ufms.model.dao.AdministradorDAO"%>
<%@page import="java.util.List"%>
<%@page import="br.ufms.model.bean.Administrador"%>
                        ...
                        <table cellspacing="0" summary="Tabela de administradores">
                            ...
                            <tbody>
                                <%
                                    ...
                                    for (Administrador admin : dao.listar()) {
                                %>
                                <tr>

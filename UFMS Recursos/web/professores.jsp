<%-- 
    ...
    Created on : 21/02/2013, 23:55:05
    Author     : Kleber
--%>

<%@page import="br.ufms.model.dao.ProfessorDAO"%>
<%@page import="br.ufms.model.bean.Professor"%>
                        ...
                        <div class="oculto">
                            ...
                            <fieldset>
                                ...
                                <p>
                                    ...
                                    <input type="text" name="siape" id="siape" size="30"/>
                                </p>
                                 <p>
                                    <label for="telefone">Telefone</label>
                                    <input type="text" name="telefone" id="telefone" size="30"/>
                                </p>
                                 <p>
                                ...
                                <p>
                                    ...
                                    <input type="password" name="senha1" id="senha1" size="30"/>
                                </p>
                                <p>
                                    <label for="senha2">Repetir Senha</label>
                                    <input type="password" name="senha2" id="senha1" size="30"/>
                                </p>
                                <p>${mensagem}</p>
                            </fieldset>
